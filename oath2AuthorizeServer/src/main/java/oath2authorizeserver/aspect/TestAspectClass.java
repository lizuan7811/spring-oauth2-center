...
public class TestAspectClass {
	...
	@Pointcut("execution(String oath2authorizeserver.aspect.TestAspectService.test(..))")
	...
	@Around("execution(String oath2authorizeserver.aspect.TestAspectService.test(..))")
