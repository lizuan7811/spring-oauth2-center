...
import oath2oauthorizeserver.controller.SelfDefiAuth;
import oath2oauthorizeserver.controller.SelfDefiAuthFail;
import oath2oauthorizeserver.controller.SelfLogoutSuccessed;
import oath2oauthorizeserver.redis.RedisConnBuilder;
import oath2oauthorizeserver.service.SelfUserDetailService;
...
public class JavaWebSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	private final SelfDefiAuth selfDefiAuth;


	@Autowired
	public JavaWebSecurityConfiguration(SelfUserDetailService selfUserDetailService, PasswordEncoder passwordEncoder,JwtAccessTokenConverter jwtAccessTokenConverter, RedisConnBuilder redisConnBuilder,SelfDefiAuth selfDefiAuth) {
		this.selfUserDetailService = selfUserDetailService;
		this.passwordEncoder = passwordEncoder;
		this.jwtAccessTokenConverter=jwtAccessTokenConverter;
		this.redisConnBuilder = redisConnBuilder;
		this.selfDefiAuth=selfDefiAuth;
	}
	  @Override
