...
//        String resourceUrl = commonProperties.getResourceUrl();
    ...
    private OAuth2AccessToken requestAccessToken(String accessTokenUrl, String clientId, String clientSecret, String redirectUri, String authorizationCode) {
        try {
...
//            TODO 401
            RequestEntity<MultiValueMap<String, String>> requestEntity = RequestEntity.post(new URI(accessTokenUrl)).headers(headers).body(requestBody);
