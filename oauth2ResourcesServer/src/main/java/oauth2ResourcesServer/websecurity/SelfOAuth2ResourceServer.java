...
//	},RequestParameterFileter requestParameterFileter){
...
//		this.requestParameterFileter=requestParameterFileter;
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/css/**","/img/**","/js/**","/lib/**","/scss/**")
				.permitAll().anyRequest().authenticated().and().cors().disable();
//		http.addFilterAfter(requestParameterFileter, UsernamePasswordAuthenticationFilter.class);
	}
